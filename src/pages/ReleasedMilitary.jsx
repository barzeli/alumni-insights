...
import { Shield, Upload, AlertCircle, Star, MapPin, List } from "lucide-react";
import {
  BarChart,
  Bar,
  XAxis,
    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
                ...
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <Bar
                      ...
                      name="קצונה"
                    />
                    <Bar dataKey="נגד" stackId="a" fill="#0891b2" name="נגד" />
                    <Bar
                      dataKey="חייל חובה"
                      stackId="a"
                      fill="#7c3aed"
        ...
        <Card className="md:col-span-2">
          <CardHeader className="flex flex-row items-center justify-between">
            <CardTitle className="text-lg text-[#1e3a5f]">אופי תפקיד</CardTitle>
            <div className="flex items-center gap-2">
              <ChartInfoButton
                title="אופי תפקיד"
